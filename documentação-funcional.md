...
Como o próprio nome sugere, é uma documentação que tem o objetivo de contextualizar e apresentar um assunto. 
Este assunto pode ser um produto, um serviço, uma funcionalidade, um recurso, enfim, apresentar uma temática para a pessoa usuária.
